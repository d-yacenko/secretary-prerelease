...
TOOL_SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        permission=ToolPermission.READ,
        input_model=ListPersonRoutesInput,
        service_method="list_person_routes",
        assistant_exposed=True,
        mcp_exposed=False,
        assistant_definition=_assistant_definition("list_person_routes"),
    ),
    ToolSpec(
        name="record_person_route_choice",
        permission=ToolPermission.ANNOTATE,
        input_model=RecordPersonRouteChoiceInput,
        service_method="record_person_route_choice",
        assistant_exposed=True,
        mcp_exposed=False,
        assistant_definition=_assistant_definition("record_person_route_choice"),
    ),
    ToolSpec(
