...
class GraphService:
    ...
    def _get_object_row(self, object_id: UUID, *, active_only: bool = False) -> Object | None:
        ...
        if active_only:
            filters.append(telegram_mtproto_ai_predicate())
    ...
    def _get_neighbors_limited(
        ...
        outgoing_filters.extend([object_is_active(Object), telegram_mtproto_ai_predicate()])
        incoming_filters.extend([object_is_active(Object), telegram_mtproto_ai_predicate()])
