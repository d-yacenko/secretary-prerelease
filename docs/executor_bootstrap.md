...
9. Do not ask the user to paste private keys, passwords, passphrases, tokens, recovery codes, or key material into chat.
10. Do not probe alternative hosts, aliases, directories, or credentials.
