...
EXPECTED_RELEASE="b7fbdc71584cfde042a998fbfefb06015175a205"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"
TARGET_FILE="$SCRIPT_DIR/target.json"
HELPER="$SCRIPT_DIR/manual_mtproto_visibility_state.py"

fail() { printf 'MANUAL_M4AT1_BLOCKED=%s\n' "$1"; exit 2; }
...
printf '%s\n' MANUAL_M4AT1_BEGIN=true CANONICAL_REPO_PASS=true TARGET_PIN_PASS=true
