...
EXPECTED_RELEASE="2db36510fe884eadc40d63fed8661ed3627f1cbb"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"
TARGET_FILE="$SCRIPT_DIR/target.json"
HELPER="$SCRIPT_DIR/manual_mtproto_inbox_eligibility.py"

fail() { printf 'MANUAL_M4AW2_BLOCKED=%s\n' "$1"; exit 2; }
...
printf '%s\n' MANUAL_M4AW2_BEGIN=true CANONICAL_REPO_PASS=true TARGET_PIN_PASS=true
